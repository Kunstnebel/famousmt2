...
class MultiTextLine(Window):
	...
	def NewTextLineWithColorAndFont(self, r, g, b, fontName):
		line = TextLine()
		line.SetParent(self)
		line.SetPosition(0, len(self.lines) * self.LINE_HEIGHT)
		if self.alignCenter == TRUE:
	...
	def SetTextWithColorAndFont(self, text, r, g, b, fontName):
		self.Clear()

		self.text = text
		line = self.NewTextLineWithColorAndFont(r,g,b, fontName)
		pos = 0
		newStartPos = 0
		while pos < len(text):
			line.SetText(text[:pos+1])
