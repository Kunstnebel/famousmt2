...
class GameWindow(ui.ScriptWindow):
	def __init__(self, stream):
		...
		self.sideBar.Show()
		self.sideBar.AddButton("Itemlager", self.interface.AskSafeboxPassword())
		self.sideBar.AddButton("Pfer rufen", self.SaveScreen)
		self.sideBar.AddButton("Teleport", self.SaveScreen)
	...
	def __BuildKeyDict(self):
		...
		onPressKeyDict[app.DIK_F8]			= lambda : self.__ChestShow()
